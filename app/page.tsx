...
export default function Home() {
 ...
 const handleClick2 = () => {
    window.open('https://www.instagram.com/eltorpeese/', '_blank')
  }

  const handleClick1 = () => {
    window.open('https://www.linkedin.com/in/carlos-daniel-quiñónez-torres-924a90230/', '_blank')
  }

  const handleClick3 = () => {
    window.open('https://github.com/ProgramadorFitness', '_blank')
  }
  return (
  <main className="flex min-h-screen flex-col items-center justify-between p-24">
      ...
      <div >
        <Image
          src={require('/Users/juni1/Proyects/portafolio/app/assets/pf.jpg')}
          alt=""
          width={300}
          height={300}
      ...
      <div className='mb-16	'>        
          <h1
          className='text-align: end font-serif w-max content-center text-5xl '>ProgramadorFitness
          </h1>
      </div>

      <div className='mb-4	'>
        <h1
          className='text-center  text-4xl '>About me
        </h1>
      </div>  

          <div className='mb-16	'>
            <h1
              className='text-center  text-3xl '>My name is Daniel Torres
            </h1>

            <h2 className='text-center'>Im passionate about software development, cooking, exercise and of course coffee,
              I like to strive for my goals, I like to commit and focus to achieve each of them.
                Below you can see a little of my work, I will value any constructive criticism.</h2>
          </div>
      
      
    <div  className='mb-16	'>
      <h1
        className='text-center  text-3xl '>Proyects
      </h1>
    ...
    <div className='mb-16	'>
      <h1
        className='text-center  text-3xl '>Contact
      </h1>

      <div className='cont'>
          <button onClick={handleClick2}><svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="100" height="100" viewBox="0 0 48 48">
          ...
          <button onClick={handleClick1}><svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="100" height="100" viewBox="0 0 64 64">
          ...
          <button onClick={handleClick3}><svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="100" height="100" viewBox="0 0 64 64">
    ...
    <div className='mb-16	'>
    <h1
        className='text-center  text-3xl'>Skills
    </h1>    </div>  
  </main>
  )
}
